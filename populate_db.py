...
for i in range (1,7):
	...
	manager = 1
	phonenumber = "123456000" + str(i)
	new_user = User(firstname=name, lastname = lastname, phonenumber = phonenumber, email=email, password=password, role = "shop")
	...
	for e in range(1, 10):
		...
		empl = User(firstname = empl_name, lastname = empl_lastname, email=empl_email, phonenumber = empl_phonenumber, password=empl_password, role=empl_role, manager = empl_manager)
		if e % 3 == 0:
